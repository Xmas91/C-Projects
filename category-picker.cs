...
//      string[] options =
//      {
//         "foo", "bar", "baz", "rumplestiltskin"
//      };

//      string answer = CategoryPicker.Prompt(
//         "Select An Option", "Please choose a category", options
//      );

//      Console.WriteLine(
//         "{0}", answer == null ? "Cancelled" : "[" + answer + "]"
//      );
//   }
//}
